...
public class InputParamsParser {
    ...
    public double[] parse(TrialgleCalculationKind calculationKind, String value) {
        switch ( calculationKind ) {
            case SIDE_AND_HEIGHT: {
                return parseSideAndHeight( value );
            }
            case THREE_SIDES: {
                return parseThreeSides( value );
            }
            case TWO_SIDES_AND_ANGLE: {
                return parseTwoSidesAndAngle( value );
            }
            default: {
                return null;
            }
